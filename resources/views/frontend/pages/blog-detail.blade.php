                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Par {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('d M, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Commentaires ({{$post->allComments->count()}})</a></span>
                                    </div>
                            ...
                            <p class="text-center p-5">
                                Vous devez <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">vous connecter</a> ou <a style="color:blue" href="{{route('register.form')}}">vous inscrire</a> pour commenter.
                            </p>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Catégories de Blog</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Abonnez-vous et recevez des nouvelles <br> des dernières mises à jour.</h4>
